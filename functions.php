...
function evo_setup() {
	...
	register_nav_menus( array( 'main-menu' => esc_html__( 'Main Menu', 'evo' ) ) );
...
function evo_load_scripts() {
	wp_enqueue_style( 'evo-style', get_stylesheet_uri() );
	wp_enqueue_style( 'evo-inter-font', get_theme_file_uri( '/assets/fonts/inter/inter.css' ), false );
	wp_enqueue_style( 'evo-plexmonomod-font', get_theme_file_uri( '/assets/fonts/plexmonomod/plexmonomod.css' ), false );
...
add_action( 'wp_enqueue_scripts', 'evo_load_scripts' );
...
function evo_widgets_init() {
	register_sidebar( array(
		'name' => esc_html__( 'Sidebar Widget Area', 'evo' ),
...
function evo_excerpt_more( $more ) {
	global $post;
	return '<a class="more-link" href="' . get_permalink($post->ID) . '">...</a>';
}
add_filter( 'excerpt_more', 'evo_excerpt_more' );

// change content more text 
function evo_read_more_link() {
	return '... <a class="more-link" href="' . get_permalink() . '">continue reading...</a>';
}
add_filter( 'the_content_more_link', 'evo_read_more_link' );
...
function evo_redirect_attachment_page() {
	if ( is_attachment() ) {
		global $post;
...
add_action( 'template_redirect', 'evo_redirect_attachment_page' );
...
<?php }
add_action( 'login_head', 'evo_login_logo' );
